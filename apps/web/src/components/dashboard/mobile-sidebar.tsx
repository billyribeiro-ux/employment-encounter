...
import { LayoutDashboard, Users, FileText, BarChart3, Calendar, Settings, FolderOpen, CheckSquare, MessageSquare, PieChart, Video, Search, Briefcase, UserCheck, CreditCard, CalendarClock, ClipboardCheck, FileSignature, Bell, Mail, Globe, Activity, Plug, Upload, Brain, GitCompare, MessageCircleQuestion, Zap, Heart, FileSearch, Kanban, Layers, ShieldCheck, ClipboardList, VideoIcon, UserPlus, Handshake, BookOpen, GraduationCap, DollarSign, Shield, SearchCheck, Scale, Menu, ChevronDown, ChevronRight } from "lucide-react";
